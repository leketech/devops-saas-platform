...
resource "aws_flow_log" "main" {
  ...
  log_format = "$${version} $${account-id} $${interface-id} $${srcaddr} $${dstaddr} $${srcport} $${dstport} $${protocol} $${packets} $${bytes} $${start} $${end} $${action} $${type} $${region} $${vpc-id} $${subnet-id} $${instance-id}"
